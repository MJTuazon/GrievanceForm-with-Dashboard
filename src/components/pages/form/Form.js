...
const Form = () => {
  ...
  const handleSubmit = (e) => {
    if (name == "" && email == "" && studentNumber == "" && contactNumber == "" && facebookLink == "" && currentCollege == "" && currentYear== "" && degreeProgram == "" && classConcern == "" && natureConcern == "" && aboutConcern == "" && concern == "") console.log("missing field");
    else {
    e.preventDefault();
    setLoader(true)
    ...
    <form className="form" onSubmit={handleSubmit}>
      ...
      />
        ...
        <select  placeholder="Current College"
          ...
          required>
            <option value="">Chat College are you currently in?</option>
